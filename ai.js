...
/* ══ Config ══
   ⚠️  SECURITY: مفتاح API يجب نقله لـ Backend قبل النشر العام.
       للتطوير المحلي فقط — لا ترفع هذا الملف على GitHub عام.
   ══ */
const AI_CONFIG = {
  /* TODO: استبدل بـ Backend proxy قبل النشر:
     API_URL: 'https://your-backend.com/api/ai' */
