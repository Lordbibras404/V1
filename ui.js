...
function renderDashboard() {
  ...
  _setEl('dashWrong',   (st.wrongCount||0).toLocaleString('ar-DZ'));
...
/* ════════════════════════════════════════════════════════
   SUMMARIES — تفويض كامل لـ summaries_module.js
   _summFilter و _summSearch معرّفتان هناك فقط
════════════════════════════════════════════════════════ */

/* renderSummaries, filterSummaries, filterSummSubj, openSummary,
   closeSummReader كلها معرّفة في summaries_module.js
   لا نعيد تعريفها هنا لتفادي SyntaxError من let المكرر */
